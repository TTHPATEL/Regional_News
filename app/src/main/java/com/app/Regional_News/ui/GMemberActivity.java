...
import com.app.Regional_News.adapter.GMemberAdapter;
...
public class GMemberActivity extends AppCompatActivity {
    public RecyclerView recyclerView;
    private ProgressBar progressBar;
    private LinearLayout lyt_not_found;
    BaseApiService mApiService;
    GMemberAdapter adapter;
    @Override
...
//        recyclerView.addItemDecoration(itemDecoration);
                    ...
                    public void onResponse(Call<Memberdata> call, Response<Memberdata> response) {
                        if (response.isSuccessful()){
                            ...
                            if (degdata.getStatus().equals("1")){
                                ...
                                Toast.makeText(GMemberActivity.this, error_message, Toast.LENGTH_SHORT).show();
    ...
    private void displayData(ArrayList<Memberlistdata> degree_list) {
        adapter = new GMemberAdapter(GMemberActivity.this, degree_list);
