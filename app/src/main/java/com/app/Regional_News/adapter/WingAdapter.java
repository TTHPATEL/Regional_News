...
import com.app.Regional_News.data.Winglistdata;
import com.app.Regional_News.ui.MemberActivity;
...
public class WingAdapter extends RecyclerView.Adapter<WingAdapter.ViewHolder> {
    ...
    public WingAdapter(Context context, ArrayList<Winglistdata> songList) {
        this.clist = songList;
    ...
    @Override
    public WingAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(WingAdapter.ViewHolder holder, int position) {
