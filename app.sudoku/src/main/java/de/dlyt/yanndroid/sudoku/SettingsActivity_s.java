...
public class SettingsActivity_s extends AppCompatActivity {
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener {
        ...
        private SettingsActivity_s mActivity;
        ...
        public void onAttach(Context context) {
            ...
            mContext = getContext();
            if (getActivity() instanceof SettingsActivity_s)
                mActivity = ((SettingsActivity_s) getActivity());
        }
            ...
            findPreference("restore_all_settings").setOnPreferenceClickListener(var1 -> {
                new AlertDialog.Builder(mContext)
                        ...
                        .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                            ...
                            MainActivity_s.colorSettingChanged = true;
                            MainActivity_s.gameSettingChanged = true;
                            mActivity.recreate();
                        })
                        .show();
                return true;
